...
if(s1===1){
    ...
    strokeWeight(3)
     ...
     text("the ,ost coins behind it. Our kingdom's future is in your hands.",10,420)
     fill("yellow")
     text("Okay",340,445)
...
if(gamestate===4){
   ...
   npc10.visible=true  
    ...
    if(mc.x>670){gamestate=5
        ...
        strokeWeight(3)
    if(s4===1){ 
        text("Hello there! Would you mind helping out an old man?",130,415) 
        fill("yellow")
...
if(gamestate===7){ 
    ...
    if(s7===1){
        text("Hello there! Do you want a ride to Jade Town of the Four Kingdoms?",10,415) 
        fill("yellow")
        text("Not now.",250,440)
        text("Sure.",400,440)
        op1=createSprite(290,440,50,20)
...
if(gamestate===8){
    ...
    if(mc.x>700){gamestate=9
        ...
        if(mousePressedOver(npc12)){s8=2 }
if(s8===1){
    strokeWeight(4)
...
if(gamestate===11){
    ...
    if(s11===2){
        ...
        if(t22===1||t22===5){ 
            ...
            if(s11===4){
            text("(Clothes and crumbs of bread.)",200,400)
            var op=createSprite(360,460,60,20)
            op.visible=false
            fill("yellow")
            text("Okay",340,465)
            ...
            if(s11===3){
                text("(Scrolls with information about Cordonia.)",100,400)
                var op=createSprite(360,460,60,20)
                op.visible=false
                fill("yellow")
...
if(gamestate===12){
    ...
    if(t22===1||t22===7){ 
        ...
        if(s12===3){
         ...
         if(s12===4){
            text("Maps with information on Cordonia's refugee base.",100,400)
            var op=createSprite(360,460,60,20)
            op.visible=false
            fill("yellow")
